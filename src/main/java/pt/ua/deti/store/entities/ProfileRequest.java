...
public class ProfileRequest {
    ...
    public ProfileRequest(String password, String address, String email, String creditCardNumber, Long creditCardValidity, String creditCardCVC, PickupPointResponse preferredPickupPointId) {
